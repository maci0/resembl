...
class TestConfig(unittest.TestCase):
    ...
    def test_load_nonexistent_config(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            with patch.dict(os.environ, {"ASMATCH_CONFIG_DIR": temp_dir}):
                config = load_config()
    ...
    def test_save_config_creates_directory(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            config_dir = os.path.join(temp_dir, "subdir", "asmatch")
            with patch.dict(os.environ, {"ASMATCH_CONFIG_DIR": config_dir}):
    ...
    def test_config_dir_respects_env(self):
        """config_dir_get should respect ASMATCH_CONFIG_DIR at call time."""
        with tempfile.TemporaryDirectory() as temp_dir:
            with patch.dict(os.environ, {"ASMATCH_CONFIG_DIR": temp_dir}):
